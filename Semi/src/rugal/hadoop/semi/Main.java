...
public class Main
{
    ...
    public static void runJob(Path smallFilePath, Path largeFilePath, Path workPath)
            throws Exception
    {
        ...
        ReplicatedFilterJob.runJob(smallFilePath, uniqueKeyOutputPath, filteredSmallOutputPath);
