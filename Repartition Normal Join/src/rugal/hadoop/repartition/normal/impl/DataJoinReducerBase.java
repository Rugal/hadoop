...
package rugal.hadoop.repartition.normal.impl;
...
public abstract class DataJoinReducerBase extends JobBase
{
     ...
     * @return
     */
    private SortedMap<Object, ResetableIterator> regroup(Object key, Iterator arg1,
     ...
     * @throws IOException
     */
    protected void collect(Object key, IntermediateData aRecord, OutputCollector output,
            Reporter reporter) throws IOException
    {
        this.collected += 1;
     ...
     * @throws IOException
     */
    private void joinAndCollect(Object[] tags, ResetableIterator[] values, Object key,
     ...
     * @throws IOException
     */
    private void joinAndCollect(Object[] tags, ResetableIterator[] values, int pos,
            Object[] partialList, Object key, OutputCollector output, Reporter reporter)
            throws IOException
    {
        ...
        if (values.length == pos)
        {
            ...
            IntermediateData combined = combine(tags, partialList);
     ...
     */
    protected abstract IntermediateData combine(Object[] tags, Object[] values);
