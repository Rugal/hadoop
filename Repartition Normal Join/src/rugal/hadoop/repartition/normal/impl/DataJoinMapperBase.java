...
public abstract class DataJoinMapperBase extends JobBase {
     ...
     */
    protected abstract IntermediateData generateTaggedMapOutput(Object value);
     ...
     */
    protected abstract Text generateGroupKey(IntermediateData aRecord);
    ...
    public void map(Object key, Object value,
        ...
        IntermediateData aRecord = generateTaggedMapOutput(value);
        if (aRecord == null) {
